...
underground_atmospheres.photos.attach(io: URI.open('https://res.cloudinary.com/dk9a86uhu/image/upload/v1621162474/sfx_shop/UndergroundAtmospheres_transp_Alternate_ehbkue.png'), filename: 'image', content_type: "image/jpg")
...
# Changing the Underground Atmospheres Pick

underground = SfxPack.where(title: "Underground Atmospheres")[0]
underground.photos.destroy_all
underground.photos.attach(io: URI.open('https://res.cloudinary.com/dk9a86uhu/image/upload/v1621162474/sfx_shop/UndergroundAtmospheres_transp_Alternate_ehbkue.png'), filename: 'image', content_type: "image/jpg")

# Assigning display order to SFX packs

monster_pack = SfxPack.where(title: "Monster SFX Pack").first
monster_pack.display_order = 1
monster_pack.price_cents = 2000
monster_pack.save

outdoor_atmospheres = SfxPack.where(title: "Outdoor Atmospheres").first
outdoor_atmospheres.display_order = 2
...
underground_atmospheres = SfxPack.where(title: "Underground Atmospheres").first
underground_atmospheres.display_order = 4
underground_atmospheres.price_cents = 2000
underground_atmospheres.save

natural_disasters = SfxPack.where(title: "Natural Disasters").first
natural_disasters.display_order = 5
natural_disasters.save

weather_effects = SfxPack.where(title: "Weather Effects").first
weather_effects.display_order = 6
weather_effects.save

ghost = SfxPack.where(title: "Ghost & Haunted").first
ghost.display_order = 7
ghost.save

free_pack = SfxPack.where(title: "Free Pack").first
free_pack.display_order = 8
free_pack.save
