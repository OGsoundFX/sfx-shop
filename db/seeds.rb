...
free = SfxPack.create(sku: "OGFS002", title:'Free Pack', description: 'the best sounds ever', category: 'fantasy, action, nature', tags: 'fantasy, guns, explosions, natural, disasters, horror', size_mb: 308, duration: '18', number_of_tracks: 51, price_cents: 0, sound_designer_id: designer.id, link: "https://soundcloud.com/ogsoundfx/free-sound-effects-pack-preview", list: "", version: 2)
