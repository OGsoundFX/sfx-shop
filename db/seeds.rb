...
test_pack_zero = SfxPack.create(sku: "OGFS001", title:'Test Pack', description: 'the best sounds ever', category: 'test', tags: 'test, free', size_mb: 570, duration: '80mn', number_of_tracks: 250, price_cents: 0, sound_designer_id: designer.id)
...
test_pack_zero.photos.attach(io: File.open(Rails.root.join("app", "assets", "images", "monster.jpg")), filename: 'image.jpg')
