...
guns_explosions = SfxPack.create(title:'Guns and Explosions', description: 'the best sounds ever', category: 'weapons', tags: 'war, realistic, battle', size_mb: 570, duration: '80mn', number_of_tracks: 250, price_cents: 1500, sound_designer_id: designer.id)
