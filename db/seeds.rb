...
monster_pack = SfxPack.create(title:'Monster Pack', description: 'the best sounds ever', category: 'monster', tags: 'scary, monster, fantasy', size_mb: 1076, duration: '90mn', number_of_tracks: 1018, price_cents: 2000, sound_designer_id: designer.id)
guns_explosions = SfxPack.create(title:'Guns and Explosions', description: 'the best sounds ever', category: 'weapons', tags: 'war, realistic, battle', size_mb: 570, duration: '80mn', number_of_tracks: 250, price_cents: 1550, sound_designer_id: designer.id)
test_pack = SfxPack.create(title:'Test Pack', description: 'the best sounds ever', category: 'test', tags: 'test, free', size_mb: 570, duration: '80mn', number_of_tracks: 250, price_cents: 100, sound_designer_id: designer.id)
